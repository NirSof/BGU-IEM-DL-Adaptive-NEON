...
* **Encoder:** Downsampling layers (32x32 to 16x16).
* **Middle:** The semantic bottleneck (8x8).
* **Decoder:** Upsampling layers (Texture and fine details).

We optimize a vector of weights W = [w_enc, w_mid, w_dec] to achieve superior restoration.
